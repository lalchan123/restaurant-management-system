...
const OfferAdBanner = () => {
  return (
    ...
    <div className="z-20 hidden h-8 items-center bg-green-950 text-white lg:flex">
        ...
        <nav className="grid items-center gap-4 lg:grid-cols-3">
          ...
          <h5 className="text-center text-sm text-primary-50">
            ...
            <Link
              ...
              onClick={() =>
                localStorage.setItem("ClaimOffer", parseInt(50))
              }
            >
              Claim Offer
            </Link>
          ...
          <ul className="flex items-center justify-end gap-4">
            <li className="menu-item flex">
              ...
              <Link className="text-sm hover:text-green-500" href="/faqs">
                Help
              </Link>
            </li>
            <li className="menu-item flex">
              {/* <Link className="text-sm hover:text-primary" href="/contact-us"> */}
              <Link className="text-sm hover:text-green-500" href="/contact-us">
                Contact Us
              </Link>
            </li>
          </ul>
