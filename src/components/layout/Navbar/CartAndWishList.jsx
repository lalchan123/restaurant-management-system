    ...
    <>
      <li className="menu-item flex">
        ...
        >
          ...
          <span className="absolute -top-2.5 end-0 z-10 inline-flex h-5 w-5 translate-x-1/2 transform items-center justify-center rounded-full bg-green-500 p-1 text-xs font-bold leading-none text-green-100">
            {cartItems.length}
          </span>
        </Link>
      </li>
      <li className="menu-item flex">
        ...
        >
          ...
          <LuHeart size={20} className="fill-green-500  text-green-500" />
          {/* <span className="absolute -top-2.5 end-0 z-10 inline-flex h-5 w-5 translate-x-1/2 transform items-center justify-center rounded-full bg-orange-500 p-1 text-xs font-bold leading-none text-red-100"> */}
          <span className="absolute -top-2.5 end-0 z-10 inline-flex h-5 w-5 translate-x-1/2 transform items-center justify-center rounded-full bg-green-500 p-1 text-xs font-bold leading-none text-green-100">
            {wishlists.length}
          </span>
