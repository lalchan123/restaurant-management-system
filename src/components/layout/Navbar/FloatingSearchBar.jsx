        ...
        <div className="flex flex-col rounded-lg bg-white shadow-sm">
          <div className="relative flex w-full">
            <span className="absolute start-4 top-3">
              ...
              <LuSearch size={16} className="text-green-500" />
            </span>
            <input
              ...
              className="block w-full rounded-lg border-transparent bg-transparent px-10 py-2.5 text-sm text-green-500 placeholder-green-500"
            ...
            >
              ...
              <LuX size={16} className="text-green-500" />
            </button>
          </div>
        </div>
      </div>
