...
const ProductDetailView = async ({ dish, restuarantName, showButtons }) => {
  ...
  // console.log("38 restuarantName", restuarantName)
  // console.log("39 restuarantName[0]?.First_Name", restuarantName[0]?.First_Name)
  

  return (
    <div>
      <div className="mb-1 flex flex-wrap items-end justify-between font-medium text-default-800">
        <h4 className="text-4xl">{dish[0]?.Product_Name}</h4>
        <h3 className="text-3xl">
          {currentCurrency}
          {dish[0]?.Selling_Price}&nbsp;
          {dish[0]?.Cost_Price && (
      ...
      {restuarantName && (
        <h5 className="mb-2 text-lg font-medium text-default-600">
          ...
          {restuarantName[0]?.First_Name} {restuarantName[0]?.Last_Name}
        </h5>
      )}
      ...
      <p className="mb-4 text-sm text-default-500">
        {dish[0]?.Product_Long_Description}
      </p>
