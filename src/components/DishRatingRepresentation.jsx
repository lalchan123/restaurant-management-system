  ...
  return (
    <>
      ...
      <div className="grid items-center gap-5 lg:grid-cols-4">
        ...
        <div className="flex flex-col items-center justify-center rounded-lg bg-green-500/10 py-8">
          <h1 className="mb-4 text-6xl font-semibold text-default-800">4.7</h1>
          <div className="mb-2 flex gap-1.5">
            <span>
              {/* <FaStar size={18} className="text-yellow-400" /> */}
              <FaStar size={18} className="text-green-400" />
            </span>
            <span>
              <FaStar size={18} className="text-green-400" />
            </span>
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div
                  ...
                  className="flex w-4/6 flex-col justify-center overflow-hidden rounded bg-green-500"
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div
                  ...
                  className="flex w-1/4 flex-col justify-center overflow-hidden rounded bg-green-500"
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div
                  ...
                  className="flex w-2/12 flex-col justify-center overflow-hidden rounded bg-green-500"
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div
                  ...
                  className="flex w-1/12 flex-col justify-center overflow-hidden rounded bg-green-500"
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
                  aria-valuemax={100}
            ...
            <div className="md:col-span-7">
              <div className="flex h-1 w-full overflow-hidden rounded-full bg-default-200">
                <div
                  ...
                  className="flex w-[4%] flex-col justify-center overflow-hidden rounded bg-green-500"
                  role="progressbar"
                  aria-valuenow={25}
                  aria-valuemin={0}
                  aria-valuemax={100}
