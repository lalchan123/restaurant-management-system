...
const OrderSummary = () => {
  ...
  console.log("ClaimOffer", parseFloat(localStorage.getItem("ClaimOffer")), typeof(parseFloat(localStorage.getItem("ClaimOffer"))))
  console.log("getCalculatedOrder", parseFloat(getCalculatedOrder().total.toFixed(2)), typeof(parseFloat(getCalculatedOrder().total.toFixed(2))))
  // const discountAmountOffer = localStorage.getItem("discountAmountOffer");
  return (
    <div className="mb-5">
      <div className="rounded-lg border border-default-200 p-5">
        ...
        <div className="mb-6">
          ...
          <div className="mb-3 flex justify-between">
            <p className="text-sm text-default-500">Service Charge</p>
            <p className="text-sm font-medium text-default-700">
              +{currentCurrency}
              {parseFloat(getCalculatedOrder().total.toFixed(2)) > parseFloat(localStorage.getItem("ClaimOffer")) ? 0 : 1 }
            </p>
          </div>
