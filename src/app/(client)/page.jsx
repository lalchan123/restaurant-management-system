            ...
            <div className="px-10 py-20">
              <div className="z-10 order-last flex items-center justify-center lg:order-first lg:justify-start">
                <div className="text-center lg:text-start">
                  ...
                  <span className="mb-8 inline-flex rounded-full bg-green-500/20 px-4 py-2 text-sm text-green-500 lg:mb-2">
                    #Special Food 🍇
                  </span>
                  <div className="mb-5 text-3xl font-bold capitalize text-default-950 md:text-5xl/snug lg:text-6xl/normal">
                    ...
                    <span className="text-green-500">Food</span> And Quick Service
                  </div>
                  ...
                  <div className="mt-10 flex flex-wrap items-center justify-center gap-5 lg:justify-normal">
                    ...
                    <button className="rounded-full bg-green-500 px-10 py-5 font-medium text-white transition-all hover:bg-green-600">
                      <Link href="/dishes">
                        Order Now
                      </Link>
                    </button>
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                ...
                <div className="rounded-md border border-default-100 bg-transparent shadow-lg transition-all duration-200 hover:border-green-500">
                  <div className="p-6">
                    <div className="mb-6">
                      <Image
                        src={cupIconImg}
